...
Во время стажировки в Elbrus Bootcamp я выполнила часть 1 «Основная логика» этого проекта.

Для проверки своей работы написала тесты в файле `spec/sudoku.spec.js`.

Для запуска судоку введите цифру от 0 до 4 в файле `runner.js` на строке 13 (puzzleNumber), затем запустите команду  `npm start` в консоли.
...
6 - - 3 - 8 9 - -
```
### Release 2: Более продвинутая логика
